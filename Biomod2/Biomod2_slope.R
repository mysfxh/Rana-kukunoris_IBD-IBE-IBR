...
single_envt <- raster("/home/xiongh/Biomod2/new/result_1/env/slope.asc")
...
my_projection <- BIOMOD_Projection(
  ...
  proj.name = 'Maxent_r1nslope.asc',     # 项目名称
