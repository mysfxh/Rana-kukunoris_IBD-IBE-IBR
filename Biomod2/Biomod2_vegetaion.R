...
single_envt <- raster("/home/xiongh/Biomod2/new/result_1/env/vegetation_type.asc")
...
myBiomodModelOut <- BIOMOD_Modeling(
  ...
  modeling.id = 'r1vegetation_type.asc',
  models = c('MAXENT'),
  CV.strategy = 'kfold',
  CV.nb.rep = 10,
  CV.perc = 0.75,
...
write.csv(eval_df,"./r1vegetation_type.asccsv")
#eval_df<-get_evaluations(myBiomodModelOut)
...
my_projection <- BIOMOD_Projection(
  ...
  proj.name = 'Maxent_Projecvegetation_r1type.asc',     # 项目名称
