...
single_envt <- raster("/home/xiongh/Biomod2/new/result_1/env/elevation.asc")
...
write.csv(eval_df,"./r1elevation.csv")
#eval_df<-get_evaluations(myBiomodModelOut)
...
my_projection <- BIOMOD_Projection(
  ...
  proj.name = 'Maxent_Projection_r1elevation',     # 项目名称
