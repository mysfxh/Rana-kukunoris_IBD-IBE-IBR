...
single_envt <- raster("/home/xiongh/Biomod2/new/result_1/env/new_river_ds.asc")
...
write.csv(eval_df,"./r1_river_ds.asc.csv")
#eval_df<-get_evaluations(myBiomodModelOut)
...
my_projection <- BIOMOD_Projection(
  ...
  proj.name = 'Maxent_Projectionnew_r1river_ds.asc',     # 项目名称
